...
//    }
    ...
    @Test
    public void setCurrentActiveUserTest(){
        // Given
        Users pete123 = new Users();
        UserManager userManager = new UserManager();
        UserManager expectedCurrentUser = userManager;

        // When
        expectedCurrentUser.setCurrentActiveUser(pete123);
        Users actualCurrentUser = expectedCurrentUser.getCurrentActiveUser();
